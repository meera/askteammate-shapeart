...
registerBlockType('askteammate/shapeart-text', {
    title: __('ShapeArt-Text', 'askteammate-shapeart'),
    description: __('Shapes On Text', 'askteammate-shapeart'),
    category: 'widgets',
    usesContext: ['backgroundColor'],
    attributes: {
        content: {
            type: 'string',
    ...
    edit: TextEdit,
    parent: ['askteammate/shapeart'],
    save: function({ attributes }) {

        const {content, textColor, childPositionX, childPositionY, backgroundColor} = attributes;

        return <text x={childPositionX} y={childPositionY} fill={backgroundColor}>{content} </text>;

        // return <RichText.Content                 style= { {backgroundColor: backgroundColor}}
        //  tagName='p' value={content}></RichText.Content>;
